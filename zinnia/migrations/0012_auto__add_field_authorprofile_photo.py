...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AuthorProfile.photo'
        db.add_column('zinnia_authorprofile', 'photo',
                      self.gf('stdimage.fields.StdImageField')(thumbnail_size={'width': 150, 'force': None, 'height': 150}, upload_to='uploads/zinnia', max_length=100, blank=True, null=True, size={'width': 1024, 'force': None, 'height': 1024}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AuthorProfile.photo'
        db.delete_column('zinnia_authorprofile', 'photo')
    ...
    models = {
        ...
        'zinnia.authorprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'photo': ('stdimage.fields.StdImageField', [], {'thumbnail_size': "{'width': 150, 'force': None, 'height': 150}", 'upload_to': "'uploads/zinnia'", 'max_length': '100', 'blank': 'True', 'null': 'True', 'size': "{'width': 1024, 'force': None, 'height': 1024}"})
        },
        'zinnia.category': {
